...
public class MyAsyncConfig01 {
	...
	/**
	 * 该方式在SpringBoot3中已经被其他类优化,无需再使用此配置,直接配置spring.task.execution即可
	 * 
	 * 相关类为{@link TaskExecutionAutoConfiguration},TaskExecutorConfigurations,TaskExecutorConfiguration,SimpleAsyncTaskExecutorBuilderConfiguration
	 * 
	 * 若需要自定义配置,可使用defaultAsyncPool()
	 * 
