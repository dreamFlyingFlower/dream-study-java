...
import com.wy.modules.alipay.service.IAliPayService;
import com.wy.modules.alipay.util.AliPayConfig;
...
public class AliPayController {
	...
	public void alipay_notify(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			signVerified = AlipaySignature.rsaCheckV1(params, alipayProperties.getPublicKey(), AliPayConfig.CHARSET,
