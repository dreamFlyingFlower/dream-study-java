package com.wy.modules.unionpay.service.impl;
...
import com.wy.common.constants.Constants;
import com.wy.common.constants.PayWay;
import com.wy.common.model.Product;
import com.wy.common.utils.CommonUtil;
import com.wy.modules.unionpay.service.IUnionPayService;
import com.wy.modules.unionpay.util.AcpService;
import com.wy.modules.unionpay.util.SDKConfig;
import com.wy.modules.unionpay.util.UnionConfig;
		...
		if (!rspData.isEmpty()) {
			...
			if (AcpService.validate(rspData, UnionConfig.encoding_UTF8)) {
				...
				if ("00".equals(respCode)) {
					...
					/*
					 * String zipFilePath = AcpService.deCodeFileContent(rspData, "d:\\",
					 ...
					 * 
					 * List<String> fileList = UnionConfig.unzip(zipFilePath, outPutDirectory);
					 * 
					 * // 解析ZM，ZME文件
					 * 
					 ...
					 * 
					 * fileContentDispaly = UnionConfig.getFileContentTable( ZmDataList, file);
					 * 
