package com.wy.modules.alipay.service;
...
/**
 * 扫码支付以及手机H5支付 创建者 科帮网 创建时间 2017年7月27日
 */
public interface IAliPayService {
	...
	/**
	 * 手机H5支付、腾讯相关软件下不支持、使用UC等浏览器打开 方法一：
	 ...
	 * 方法二： 如果是远程调用返回消费放一个form表单 然后调用方刷新到页面自动提交即可
	 * 
	 * @Author 科帮网
	 * @param product
	 * @return String
	 * @Date 2017年7月27日 更新日志 2017年7月27日 科帮网 首次创建 备注：人民币单位为分 attach 附件参数 使用json格式传递
	 *       用于回调区分
	 */
	 ...
	 * @param product
	 * @return String
	 * @Date 2017年9月21日 更新日志 2017年9月21日 科帮网 首次创建
	 *
	 */
