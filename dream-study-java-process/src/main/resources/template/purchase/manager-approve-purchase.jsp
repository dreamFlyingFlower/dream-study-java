...
<html>
  ...
  <body>
    <form action="manager-approve-purchase.jsp" method="post"> 
    	...
    	<input type="radio" name="approve_result" value="1" checked="checked"/>
    	同意&nbsp;&nbsp;
    	<input type="radio" name="approve_result" value="0"/>
    	不同意<br/>
    	<input type="radio" name="approve_result" value="purchase_backtomod"/>
    	驳回修改<br/>
