package dream.study.spring.listener;
...
/**
 * SpringApplicationRunListener:Spring整个启动过程监听器,所有的监听器实现类都在{@link SpringApplication#run}中调用
 * 
 ...
 */
public class SelfApplicationListener implements SpringApplicationRunListener {
	 ...
	 * @param args
	 */
	public SelfApplicationListener(SpringApplication application, String[] args) {
	}
