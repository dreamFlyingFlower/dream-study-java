...
public class CnCalendarUtil {
	 ...
	 * <b>功能说明：</b>：传出y年m月d日对应的农历.year0 .month1 .day2 .yearCyl3 .monCyl4 .dayCyl5
	 * .isLeap6<br>
	 * 
	 * @author <font color='blue'>束文奇</font>
	 ...
	 * 
	 * // 传出y年m月d日对应的农历.year0 .month1 .day2 .yearCyl3 .monCyl4 .dayCyl5 .isLeap6
	 * public static void main(String[] args) { Calendar cld =
	 * Calendar.getInstance(); int year = cld.get(Calendar.YEAR); int month =
	 * cld.get(Calendar.MONTH) + 1; int day = cld.get(Calendar.DAY_OF_MONTH); String
	 * week = ""; long[] l = calElement(year, month, day);
	 * 
	 * switch (cld.get(Calendar.DAY_OF_WEEK)) { case 1: week = "日"; break; case 2:
	 * week = "一"; break; case 3: week = "二"; break; case 4: week = "三"; break; case
	 * 5: week = "四"; break; case 6: week = "五"; break; case 7: week = "六"; break; }
	 * 
	 * String n = ""; switch ((int) (l[1])) { case 1: n = "一"; break; case 2: n =
	 * "二"; break; case 3: n = "三"; break; case 4: n = "四"; break; case 5: n = "五";
	 * break; case 6: n = "六"; break; case 7: n = "七"; break; case 8: n = "八";
	 * break; case 9: n = "九"; break; case 10: n = "十"; break; case 11: n = "十一";
	 * break; case 12: n = "十二"; break; } try { String a = "北京时间： " + year + "年" +
	 * month + "月" + day + "日<br/>
	 * 星期" + week + " 农历" + n + "月" + getchina((int) (l[2])); String b = "北京时间： " +
	 * year + "年" + month + "月" + day + "日 星期" + week + " 农历" + n + "月" +
	 * getchina((int) (l[2])); BufferedWriter outout = new BufferedWriter(new
	 * FileWriter( "rili.html", false)); outout.write(a); outout.close(); } catch
