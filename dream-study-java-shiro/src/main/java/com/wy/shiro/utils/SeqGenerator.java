...
/**
 * 雪花算法,生产的序列有序,参考Twitter Snowflake
 * 
 * Snowflake算法(64位自增ID):41bit时间戳(可使用约70年)+10bit机器服务标识(可支持1024个服务)+12bit序列号(1毫秒可产生4095个序列)
 *
 * @author 飞花梦影
 * @date 2022-06-22 00:48:38
...
public class SeqGenerator {
	...
	public long tilNextMillis(final long lastTimestamp) {
		long timestamp = this.timeGen();
