...
},beforePageText:"第",afterPageText:"页 共{pages}页",displayMsg:"总共<span style='color:red; line-height:30px;'> {total} </span>条记录",nav:{first:{iconCls:"pagination-first",handler:function(){
