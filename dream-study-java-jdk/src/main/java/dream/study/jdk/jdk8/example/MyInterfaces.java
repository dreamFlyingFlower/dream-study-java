package dream.study.jdk.jdk8.example;
 ...
 * 
 * <pre>
 * 当接口A中定义了default方法test1时,若是B继承A,同时也定义了default方法test1.
...
public interface MyInterfaces {
	...
	static void test2() {
		System.out.println("MyInterfaces.test2");
	}

	static void test3() {
		System.out.println("MyInterfaces.test3");
	}
}